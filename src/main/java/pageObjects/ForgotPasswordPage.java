...
public class ForgotPasswordPage extends GeneralPage {
    ...
    //Elements
    protected WebElement getTxtEmailAddress() {return Constant.WEBDRIVER.findElement(By.xpath("//form//input[@id='email']")); }
    protected WebElement getBtnSendInstructions() { return Constant.WEBDRIVER.findElement(By.xpath("//form//input[@type='submit']")); }
